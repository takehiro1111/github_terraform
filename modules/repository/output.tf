output "github_pubnlic_repos" {
  ...
  value = [
    ...
    {repo_name = "menta-python-lesson", visibility = "public" , archived = false , description = "Mentaの学習用リポジトリ", allow_auto_merge = false },
    {repo_name = "menta-typescript-lesson", visibility = "public" , archived = false , description = "Mentaの学習用リポジトリ", allow_auto_merge = false},
    {repo_name = "pytest", visibility = "public" , archived = false , description = "pytestの学習"},
    {repo_name = "menta-flask-todo", visibility = "public" , archived = false , description = "Flaskを用いたTODOアプリの実装", allow_auto_merge = false},
    {repo_name = "menta-go-lesson", visibility = "public" , archived = false , description = "Golangの学習用リポジトリ", allow_auto_merge = false},
    ...
    {repo_name = "gin-api", visibility = "public" , archived = false , description = "Gin Web Frameworkを用いたAPI実装", allow_auto_merge = false},
  ]
}
