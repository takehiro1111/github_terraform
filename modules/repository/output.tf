output "github_pubnlic_repos" {
  ...
  value = [
    ...
    {repo_name = "python-basic", visibility = "public" , archived = false , description = "", allow_auto_merge = false },
    {repo_name = "typescript-basic", visibility = "public" , archived = false , description = "", allow_auto_merge = false},
    {repo_name = "pytest", visibility = "public" , archived = false , description = "pytestの学習"},
    {repo_name = "flask-todo", visibility = "public" , archived = false , description = "Flaskを用いた簡易的なTODOアプリの実装", allow_auto_merge = false},
    {repo_name = "go-basic", visibility = "public" , archived = false , description = "Golangの学習用リポジトリ", allow_auto_merge = false},
    ...
    {repo_name = "react-next", visibility = "public" , archived = false , description = "", allow_auto_merge = false},
    ...
    {repo_name = "gin-todo", visibility = "public" , archived = false , description = "Ginを用いたRest APIでのTodoアプリ", allow_auto_merge = false},
    ...
    {repo_name = "self_promotion_suga", visibility = "public" , archived = false , description = "", allow_auto_merge = false},
